 ...
 * </dl>
 *
 * @deprecated  Usecom.viasat.wildblue.common.exception.fault.WildBlueFaultException
 *              instead.
 */
@Deprecated public class WildBlueFaultException extends RuntimeException
